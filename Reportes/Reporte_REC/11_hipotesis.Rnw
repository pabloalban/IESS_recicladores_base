...
variación, período 2021 a 2060, el detalle de los cálculos se encuentra en el capítulo \ref{chp_contexto}. 

 \begin{table}[H]
 \centering
 \caption{Promedio de los valores estimados de tasas de variación (período 2021 a 2060)}
